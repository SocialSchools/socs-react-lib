  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {this.state.debug &&
        <AbsDiv>
          x: {this.state.x.toFixed(0)} &nbsp;
          y: {this.state.y.toFixed(0)} &nbsp;
          scale: {this.state.scale.toFixed(2)} &nbsp;
          w: {this.state.width.toFixed(0)} &nbsp;
          h: {this.state.height.toFixed(0)}<br />
          w: {this.props.width.toFixed(0)} &nbsp;
          h: {this.props.height.toFixed(0)}
        </AbsDiv>
        }
      </div>
    );
